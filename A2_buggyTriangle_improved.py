...
def classifyTriangle(a,b,c):
    ...
    '''Bug 5'''
    if a == b and b == c:                   #bug   a==b and b==c
        return 'Equilateral'
    #Bug 6 elif ((a * 2) + (b * 2)) == (c * 2):    #bug   a*a + b*b = c*c   and should be ordered
    elif ((a * a) + (b * b) == (c * c)) or  ((a * a) + (c * c) == (b * b)) or  ((c * c) + (b * b) == (a * a)):
        return 'Right'
    #Bug 7   it should be a!=b b!=c c!=a
...
class TestTriangles(unittest.TestCase):
    ...
    def testClassifyTriangle4(self): # test invalid inputs
        self.assertEqual(classifyTriangle('a',100,200),'InvalidInput','should be InvalidInput')
    ...
    def testClassifyTriangle10(self): 
        self.assertEqual(classifyTriangle(3,6,3),'NotATriangle','should be NotATriangle')   
    ...
    def testClassifyTriangle20(self): 
        self.assertEqual(classifyTriangle(200,200,200),'Equilateral','should be equilateral')
    def testClassifyTriangle21(self): 
        self.assertEqual(classifyTriangle(5,3,5),'Isoceles','should be Isoceles')
